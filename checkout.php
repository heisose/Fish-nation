  ...
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo d-flex align-items-center me-auto me-xl-0">
        <h1 class="sitename">FishNation</h1><span>.</span>
      </a>
  ...
  <main class="main">
    ...
    <section class="page-header">
      <div class="container text-center" data-aos="fade-up">
        ...
        <p class="mt-3 fs-5">Review your selected fishlings before payment.</p>
      </div>
    </section>
  ...
  <h3 class="mb-4">Cart Items</h3>
            ...
            <?php else: ?>
              <div class="empty-box" data-aos="fade-up">
                ...
                <p class="text-muted">You haven’t added any fishlings yet. Browse available stock and start shopping.</p>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        ...
        <div class="col-lg-4 col-md-6 footer-info">
          ...
          <p>
            Premium fishlings for serious fish farmers. Healthy stock, dependable supply, and trusted delivery.
          </p>
        </div>
