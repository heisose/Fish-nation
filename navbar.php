  ...
  <div class="fn-inner">
    ...
    <nav id="fn-nav" role="navigation" aria-label="Main navigation">
      <ul>
        ...
        <li><a href="shop.php"<?= nav_active('shop',    $current_page) ?>>Shop</a></li>
        <li><a href="tools.php"<?= nav_active('tools',   $current_page) ?>><i class="bi bi-calculator"></i> Tools</a></li>
        ...
        <?php else: ?>
          <li>
            <a href="login.php?return_to=<?= urlencode($current_url) ?>" title="Log in">
